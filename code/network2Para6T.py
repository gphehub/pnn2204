...
class Network(object):
    ...
    def saved_weight_loader(self, filename): #mod_6S
    ...
    def backprop(self, x, y, epochs, epochs_sep, j): #mod_1a
        ...
        for l in range(2, self.num_layersNN1): #mod_1a
            ...
            deltaNN1 = np.dot(self.weightsNN1[-l+1].transpose(), deltaNN1) * spNN1 #mod_1a #point 4 of Sec. 2.6
...
def activation_fn(z): #mod_4R
    """The sigmoid function."""
    # return 1.0/(1.0+np.exp(-z)) #mod_4S #mod_6T
    """The ReLU function.""" #mod_4R
    # return np.where(z<0,0,z) #mod_4R #mod_4S
    """The Tanh function."""
    return 2*sigmoid(2*z)-1 #mod_6T

def activation_fn_prime(z): #mod_4R
    """Derivative of the sigmoid function."""
    # return sigmoid(z)*(1-sigmoid(z)) #mod_4S #mod_6T
    """Derivative of the ReLU function.""" #mod_4R
    # return np.where(z<0,0,1) #mod_4R #mod_4S
