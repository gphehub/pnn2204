"""
Versions:
main2204_2Para_load_6T.py:
Based on main2204_2Para_load_6S.py,
modified to run network2Para_load_6T.py.
Modifications are indicated by '#mod_LD6T'
...
import network2Para_load_6T #mod_LDR #mod_LDS #mod_LD5S #mod_LD6S #mod_LD6T
net_load = network2Para_load_6T.Network() #mod_LDR #mod_LDS #mod_LD5S #mod_LD6S #mod_LD6T
