...
# 子网1的层（大幅增加参数）
conv1_sub1 = layers.Conv2D(32, (3, 3), activation='relu', padding='same', name='conv1_sub1')(input_layer)  # 16→32
conv1_sub1 = layers.BatchNormalization()(conv1_sub1)
pool1_sub1 = layers.MaxPooling2D((2, 2), name='pool1_sub1')(conv1_sub1)

conv2_sub1 = layers.Conv2D(64, (3, 3), activation='relu', padding='same', name='conv2_sub1')(pool1_sub1)  # 32→64
conv2_sub1 = layers.BatchNormalization()(conv2_sub1)
pool2_sub1 = layers.MaxPooling2D((2, 2), name='pool2_sub1')(conv2_sub1)

# 新增第三层卷积（额外增加参数）
conv3_sub1 = layers.Conv2D(128, (3, 3), activation='relu', padding='same', name='conv3_sub1')(pool2_sub1)
...
dense1_sub1 = layers.Dense(128, activation='relu', name='dense1_sub1')(flatten_sub1)  # 64→128
...
conv1_sub2 = layers.Conv2D(32, (3, 3), activation='relu', padding='same', name='conv1_sub2')(input_layer)  # 16→32
conv1_sub2 = layers.BatchNormalization()(conv1_sub2)
pool1_sub2 = layers.MaxPooling2D((2, 2), name='pool1_sub2')(conv1_sub2)

conv2_sub2 = layers.Conv2D(64, (3, 3), activation='relu', padding='same', name='conv2_sub2')(pool1_sub2)  # 32→64
conv2_sub2 = layers.BatchNormalization()(conv2_sub2)
pool2_sub2 = layers.MaxPooling2D((2, 2), name='pool2_sub2')(conv2_sub2)

# 新增第三层卷积
conv3_sub2 = layers.Conv2D(128, (3, 3), activation='relu', padding='same', name='conv3_sub2')(pool2_sub2)
...
dense1_sub2 = layers.Dense(128, activation='relu', name='dense1_sub2')(flatten_sub2)  # 64→128
